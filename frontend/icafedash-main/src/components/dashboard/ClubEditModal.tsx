  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[560px]">
        <DialogHeader>
          <DialogTitle className="font-display text-xl">Редактирование: {club.name}</DialogTitle>
          <DialogDescription>Изменения сохраняются в карточке клуба и используются во всех клиентских экранах.</DialogDescription>
        </DialogHeader>
